      ...
      ws_prep: {
        ...
        activities: [
          fix('Zuri’s story has eight prepositions that do not fit. Click the right one from the bank for each.',
            ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'], [
              { given: 'Zuri and her team entered the observatory ____ a winding pathway near the coastal bluff.', answer: 'past',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'],
                flag: 'Answer inferred. The deck does not mark which preposition is the error here, and "past a winding pathway" is the weakest of the eight.' },
              { given: 'Their mentor stood ____ the doorway and explained the research guidelines.', answer: 'beside',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'],
                flag: 'Answer inferred. "in the doorway" is the idiom a fifth grader would write, and "in" is not in the bank.' },
              { given: 'The visitors walked ____ the metal corridor while shining their lanterns.', answer: 'through',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'] },
              { given: 'Zuri noticed small gears ____ the copper rafters.', answer: 'behind',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'],
                flag: 'Answer inferred. "along the copper rafters" reads as correct English, so this may not be one of the eight at all.' },
              { given: 'Later, the team rested beside a large telescope ____ the platform.', answer: 'near',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'] },
              { given: 'A small clockwork mouse quickly ran ____ the brass track to hide from the visitors.', answer: 'between',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'],
                flag: 'Answer inferred, and the weakest one. "ran between the brass track" does not read as English — "between" is the only bank word left over, which is why it landed here.' },
              { given: 'The mentor pointed ____ the observatory where a narrow staircase curved toward the dome.', answer: 'across',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'] },
              { given: 'Before sunset, Zuri placed her notebook ____ the workbench and wrote notes about the observatory.', answer: 'on',
                options: ['through', 'between', 'beside', 'past', 'behind', 'near', 'on', 'across'] },
            ],
            'Read the sentence with your word in it and picture it. If you cannot picture it, it is the wrong word.'),
        ],
        flag: 'The worksheet says "replace each underlined prepositional error", but the underlining is not stored in the file — no text run carries it. These eight targets are read from the passage, not from the key. Each bank word is used exactly once, which is a good sign, but four items are individually flagged. Confirm against the answer key or the solution videos before this goes live.',
      },
      ws_pron: {

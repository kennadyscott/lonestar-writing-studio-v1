...
export function seedState() {
  const assignments = [
    { id: 'asg_recess', bridge: {
      'simplePrompt': 'Should recess be longer? Write to your principal. Tell why.',
      'steps': [
            'What is recess?',
            'Do you want more recess? Yes or no?',
            'Why? Give two reasons.'
      ],
      'chunks': [
            'Some people think the school day should include more recess time.',
            'Write an argument telling your principal whether recess should be longer.',
...
}, languageObjective: 'Give an opinion and support it out loud and in writing using because, in my opinion, and one reason is.', title: 'Should recess be longer?', genre: 'argument', type: 'Argument', format: 'ECR', questions: 1, gradeLevel: 6,
    ...
    { id: 'asg_fridge', bridge: {
      'simplePrompt': 'Is the refrigerator very important? Say yes or no. Tell why.',
      'steps': [
      ...
      'chunks': [
            'Was the refrigerator one of the most important inventions ever?',
            'Write an argument that takes a side',
            'and backs it up with reasons.'
      ],
      'vocab': [
            'invention',
            'argument',
...
}, languageObjective: 'Compare two ideas in writing using more important than, however, and this matters because.', title: 'How Refrigerators Changed Our Food', genre: 'argument', type: 'Argument', format: 'ECR', questions: 1, gradeLevel: 6,
    ...
    { id: 'asg_robot', bridge: {
      'simplePrompt': 'A robot wakes up in a garden. Write what happens next.',
      'steps': [
            'Where is the robot?',
      ...
      'chunks': [
            'A robot wakes up in a garden for the first time.',
...
}, languageObjective: 'Tell events in order using first, next, then, and finally.', title: 'The Robot in the Garden', genre: 'narrative', type: 'Narrative', format: 'SCR', questions: 3, gradeLevel: 6,
    ...
    { id: 'asg_desert', bridge: {
      'simplePrompt': 'A desert is very hot and dry. How do people live there? Tell how.',
      'steps': [
            'What is a desert like?',
            'What do people need to live?',
            'How do people get what they need in a desert?'
      ],
      'chunks': [
            'Explain how people adapt to live in a desert.',
            'Use clear reasons and details',
...
}, languageObjective: 'Explain a cause and its effect using so that, in order to, and as a result.', title: 'How People Live in the Desert', genre: 'informational', type: 'Informational', format: 'ECR', questions: 1, gradeLevel: 6,
    ...
    { id: 'asg_1776', bridge: {
      'simplePrompt': 'You live long ago, during a war. Write about one brave day.',
      'steps': [
            'Who are you in the story?',
            'What brave thing happens?',
            'How do you feel?'
      ],
      'chunks': [
            'Imagine you lived during the American Revolution.',
            'Write a story about one brave day.'
      ],
      'vocab': [
            'imagine',
            'American Revolution',
...
}, languageObjective: 'Describe a character’s feelings using past-tense verbs and sensory words.', title: 'The Brave Little Girl of 1776', genre: 'narrative', type: 'Narrative', format: 'SCR', questions: 2, gradeLevel: 6,
    ...
    { id: 'asg_kindness', bridge: {
      'simplePrompt': 'Why is kindness important in class? Tell why. Give examples.',
      'steps': [
            'What is kindness?',
            'Why does kindness help a class?',
            'What is one example?'
      ],
      'chunks': [
            'Explain why kindness matters in a classroom.',
...
}, languageObjective: 'Give an example in writing using for example, such as, and this shows that.', title: 'The Power of Kindness', genre: 'informational', type: 'Informational', format: 'SCR', questions: 1, gradeLevel: 6,

...
export function seedState() {
  ...
  return {
    ...
    fluencyGames: [
      ...
      { id: 'fg_tense', title: 'Tense Time Machine', icon: '⏰', skill: 'Verb Tense', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/verb-tense/' },
      { id: 'fg_factory', title: 'Word Factory', icon: '🤖', skill: 'Compound Words', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/compound-words/' },
      { id: 'fg_potion', title: 'Potion Words', icon: '🧪', skill: 'Synonyms & Antonyms', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/synonyms-antonyms/' },
      { id: 'fg_bridge', title: 'Bridge Builder', icon: '🌉', skill: 'Compound Sentences', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/compound-sentences/' },
      { id: 'fg_purpose', title: 'Purpose Detective', icon: '🕵️', skill: "Author's Purpose", grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/authors-purpose/' },
      { id: 'fg_library', title: 'Library Dash', icon: '📚', skill: 'Alphabetization', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/alphabetization/' },
      { id: 'fg_hero', title: 'Hero Swap', icon: '🦸', skill: 'Nouns & Pronouns', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/nouns-pronouns/' },
      { id: 'fg_safari', title: 'Syllable Safari', icon: '🥁', skill: 'Multisyllabic Words', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/multisyllabic-words/' },
      { id: 'fg_station', title: 'Word Part Station', icon: '🚀', skill: 'Affixes & Spelling', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/affixes/' },
      { id: 'fg_gems', title: 'Cave of Story Gems', icon: '💎', skill: 'Infer Theme', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/infer-theme/' },
      { id: 'fg_studio', title: 'Story Studio', icon: '🎬', skill: 'Plot, Setting & Characters', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/plot-setting-characters/' },
      { id: 'fg_surf', title: 'Word Surf', icon: '🌊', skill: 'High-Frequency Words', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/high-frequency-words/' },
      { id: 'fg_diver', title: 'Word Diver', icon: '🤿', skill: 'Determine Meaning', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/determine-meaning/' },
      { id: 'fg_rhyme', title: 'Rhyme Peaks', icon: '🎵', skill: 'Poetry', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/poetry/' },
      { id: 'fg_forest', title: 'Storybook Forest', icon: '📖', skill: "Children's Literature", grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/childrens-literature/' },
      { id: 'fg_prix', title: 'Grammar Grand Prix', icon: '🏁', skill: 'Adjectives & Adverbs', grades: '3–5', kind: 'external', url: 'https://pastorsophia.github.io/ck12/adjectives-adverbs-prepositions/' },

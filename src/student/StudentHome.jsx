...
// Tile art: her enchanted-forest Fluency Zone cards (public/zone/<id>-forest.webp, 2026-09-24),
// replacing the space-theme set.
          ...
          {tiles.map((tile) => {
            ...
            return (
              <div key={tile.id} className={`zone-tile${openable ? ' playable' : ''}`} role={!soon ? 'button' : undefined} tabIndex={!soon ? 0 : -1}
                ...
                <div aria-hidden style={{ width: '100%', aspectRatio: '720 / 328', backgroundImage: `url(${BASE}zone/${tile.id}-forest.webp)`, backgroundSize: 'cover', backgroundPosition: 'center 46%', borderBottom: '1px solid var(--gold-line)', filter: done ? 'saturate(.2) brightness(.85)' : soon ? 'saturate(.5)' : 'none' }} />
